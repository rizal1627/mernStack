    ...
    <div className='max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300'>
        <form onSubmit={saveProduct} className='my-10'>
            <div className="flex flex-col">
                ...
                <button type='submit' className='w-full py-3 font-bold text-white bg-indigo-700 hover:bg-indigo-500 rounded-lg border-indiog-600 hover:shadow'>Save</button>
            </div>
        </form>
        <Link to="/" className='flex justify-center w-20 py-1 bg-indigo-300 rounded-full '> Back</Link>
    </div>
  )
}
